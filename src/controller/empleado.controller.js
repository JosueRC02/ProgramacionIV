...
export const postEmpleados = async (req, res) => {
    try {
        const {codigo_empleado,nombre_empleado,primer_apellido_empleado,segundo_apellido_empleado,
               fec_nac_empleado,edad_empleado,nacionalidad_empleado,direccon_empleado,
